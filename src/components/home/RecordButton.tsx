  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-4">
      <button 
        ...
        className="fixed bottom-6 right-6 w-12 h-12 md:w-14 md:h-14 bg-amber-400 rounded-full flex items-center justify-center shadow-lg hover:bg-amber-300 transition-colors group"
      >
