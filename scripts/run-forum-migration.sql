-- Run this script to create forum tables
-- You can execute this in Supabase SQL editor
...
-- Only admins can manage boards (check if user_roles table exists first)
DO $$
BEGIN
...
DROP TRIGGER IF EXISTS update_forum_boards_updated_at ON forum_boards;
...
INSERT INTO forum_boards (name, description, slug, icon, sort_order) VALUES
    ('Introductions & Business', 'Introduce yourself, your business, causes, or what you''re looking to achieve', 'introductions-business', 'handshake', 1),
    ('Business Growth & Tips', 'Exchange tips, strategies, and discussions about growing businesses', 'business-growth-tips', 'trending-up', 2)
